 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 225 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_MIN_POS + X_MAX_POS)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (Y_MIN_POS + Y_MAX_POS)    // Y point for Z homing when homing all axes (G28).
#endif
